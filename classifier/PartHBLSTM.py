...
(x_train, y_train), (x_test, y_test) = load_data('./RBHNN_dataset',0.8, UNFOLD_SIZE)

part_lstm = []
for group in PART_GROUPS:
    part_lstm.append(PartLSTM(group, (x_train, y_train), (x_test, y_test),UNFOLD_SIZE))

x_validation = x_test[:len(x_test)/2]
y_validation = y_test[:len(y_test)/2]
